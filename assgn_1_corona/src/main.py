...
# data = pd.read_csv("C:\\Users\\hp\\Desktop\\OSTDS\\assgn_1_corona\\data\\01-01-2021.csv")
# df = pd.DataFrame(data)
  
# cleaned_data = clean_data(df) 
# cleaned_data.to_csv('C:\\Users\\hp\\Desktop\\OSTDS\\assgn_1_corona\\data\\processed_data.csv', index=False) 
